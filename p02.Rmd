...
tsum_TOST(m1 = toster_inputs_gist$mean[1], m2 = toster_inputs_gist$mean[2], sd1 = toster_inputs_gist$sd[1], sd2 = toster_inputs_gist$sd[2], n1 = toster_inputs_gist$n[1], n2 = toster_inputs_gist$n[2], low_eqbound = -0.30, high_eqbound = 0.30, alpha = 0.05, var.equal = FALSE,eqbound_type="SMD")
