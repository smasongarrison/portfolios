...
<strong>How do I find the relevant repository on Github Desktop?</strong>
...
<strong>How do I get the relevant files into Rstudio so that I can work on them?</strong>
...
<strong>How (Where) to answer the questions that Mason asks in her assignments?</strong>
...
<strong>How (Where) are my answers stored?</strong>
...
<strong>How can I make my files visible so that Mason can see them?</strong>
...
<strong>How can I notify Mason that my lab is done?</strong>
...
1. Go to Mason’s github, and access the relevant lab (i.e., the one you cloned).
...
<strong>How can I read Mason’s comments on my lab?</strong>
